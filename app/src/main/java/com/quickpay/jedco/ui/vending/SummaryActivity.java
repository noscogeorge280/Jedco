...
public class SummaryActivity extends DaggerAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.amount.setText(helperRegistry.formatCurrency(response.getAmount_paid()));
        binding.unit.setText("" + response.getUnits());
        binding.token.setText(response.getToken());
        binding.meterNumber.setText("" + response.getAccount_number());
        binding.arrearsBalance.setText(helperRegistry.formatCurrency(String.valueOf(response.getOutstanding_paid())));
        binding.sCustomerName.setText(response.getCustomer_name());
        binding.customerAddress.setText(response.getCustomer_address());
        binding.total.setText(helperRegistry.formatCurrency(String.valueOf(response.getAmount_paid())));
